...
class Laboratory_Direction extends ActiveRecord {
	...
	public function relations() {
		return [
			'medcard' => [ self::BELONGS_TO, 'Laboratory_Medcard', 'medcard_id', 'with' => 'patient' ],
			'analysis_type' => [ self::BELONGS_TO, 'Laboratory_AnalysisType', 'analysis_type_id' ],
